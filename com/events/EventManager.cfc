...
<cffunction name="init" hint="Constructor" access="public" returntype="EventManager" output="false">
	...
	<cfscript>
		...
		setSoftReferenceAdapterPool(createObject("component", "transfer.com.events.adapter.collections.SoftReferenceAdapterPool").init(arguments.javaLoader));
...
<!--- 
<cffunction name="removeAfterDiscardObserver" hint="removes a before Delete observer from the collection" access="public" returntype="void" output="false">
	<cfargument name="observer" hint="The observer to remove" type="any" required="Yes">
	<cfscript>
		removeObserver(arguments.observer, "AfterDiscard");
	</cfscript>
</cffunction> --->
...
<cffunction name="getCollectionByType" hint="Returns the right collection created, from a Facade" access="private" returntype="transfer.com.events.collections.AbstractBaseObserverCollection" output="false">
	...
	--->
		<cfif arguments.type eq "aftercreate">
		...
		<cfelseif arguments.type eq "afterdelete">
		...
		<cfelseif arguments.type eq "afterupdate">
		...
		<cfelseif arguments.type eq "beforecreate">
		...
		<cfelseif arguments.type eq "beforedelete">
		...
		<cfelseif arguments.type eq "beforeupdate">
		...
		<cfelseif arguments.type eq "AfterDiscard">
			<cfif NOT facade.hasAfterDiscardObserverCollection()>
				<cflock name="eventmanager.getcollectionbyytpe.#arguments.type#" timeout="60" throwontimeout="true">
					<cfif NOT facade.hasAfterDiscardObserverCollection()>
						<cfset facade.setAfterDiscardObserverCollection(createObserverCollection(arguments.type, scope))>
					</cfif>
				</cflock>
			</cfif>
			<cfreturn facade.getAfterDiscardObserverCollection()>

		<cfelseif arguments.type eq "afternew">
...
<cffunction name="createObserverCollection" hint="Returns the right collection created, unless it's for 'None' scoped intances" access="private" returntype="transfer.com.events.collections.AbstractBaseObserverCollection" output="false">
	...
	<cfscript>
		...
		{
			case "aftercreate":
				return createObject("component", "transfer.com.events.collections.AfterCreateObserverCollection").init();
			break;
			case "afterdelete":
				return createObject("component", "transfer.com.events.collections.AfterDeleteObserverCollection").init();
			break;
			case "afterupdate":
				return createObject("component", "transfer.com.events.collections.AfterUpdateObserverCollection").init();
			break;
			case "beforecreate":
				return createObject("component", "transfer.com.events.collections.BeforeCreateObserverCollection").init();
			break;
			case "beforedelete":
				return createObject("component", "transfer.com.events.collections.BeforeDeleteObserverCollection").init();
			break;
			case "beforeupdate":
				return createObject("component", "transfer.com.events.collections.BeforeUpdateObserverCollection").init();
			break;
			case "AfterDiscard":
				return createObject("component", "transfer.com.events.collections.AfterDiscardObserverCollection").init();
			break;
			case "afterNew":
				return createObject("component", "transfer.com.events.collections.AfterNewObserverCollection").init();
			break;
			default:
