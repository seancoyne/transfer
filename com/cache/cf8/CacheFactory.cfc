...
<cffunction name="getDiscardQueueHandler" hint="returns a discard queue handler" access="public" returntype="transfer.com.cache.DiscardQueueHandler" output="false">
	<cfreturn getSingleton("transfer.com.cache.cf8.DiscardQueueHandler") />
</cffunction>
