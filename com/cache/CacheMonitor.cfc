...
<cffunction name="getTotalHitMissRatio" hint="returns the ratio of total hits vs total misses. Values above 1 mean that more hits are occuring than misses." access="public" returntype="numeric" output="false">
	<cfscript>
