...
<cffunction name="__getIsProxy" hint="returns whether or not this is a proxy object (__so as to not run into any other methods)" access="public" returntype="boolean" output="false">
	<cfreturn true />
</cffunction>

<cffunction name="__getIsLoaded" access="public" hint="Whether or not the proxy has loaded the the object its proxying" returntype="boolean" output="false">
...
<cffunction name="setIsPersisted" access="package" returntype="void" output="false">
	...
	<cfscript>
		if(NOT (__getIsLoaded() OR arguments.isPersisted))
		{
			proxy("setIsPersisted", arguments);
		}
	</cfscript>
</cffunction>
...
<cffunction name="setIsDirty" access="package" returntype="void" output="false">
	...
	<cfscript>
		if((__getIsLoaded() OR arguments.isDirty))
		{
			proxy("setIsDirty", arguments);
		}
	</cfscript>
</cffunction>
