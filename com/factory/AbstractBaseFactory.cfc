...
<cffunction name="getSingleton" hint="creates and keeps a singleton" access="private" returntype="web-inf.cftags.component" output="false">
...
<cffunction name="autowire" hint="autowires a bean by class name" access="private" returntype="web-inf.cftags.component" output="false">
	<cfargument name="object" hint="the object to autowire" type="web-inf.cftags.component" required="Yes">
	<cfscript>
...
<cffunction name="getSingletonFromCache" hint="returns the singleton from the cache" access="private" returntype="web-inf.cftags.component" output="false">
