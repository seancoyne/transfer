...
<cffunction name="__getIsProxy" hint="returns whether or not this is a proxy object. Since this is a TrasferObject, it returns false." access="public" returntype="boolean" output="false">
	<cfreturn false />
</cffunction>

<cffunction name="__getIsLoaded" hint="easy way to determine if the data is loaded, since this is a TransferObject, it must be loaded, and therefore returns true."
