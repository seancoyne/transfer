...
<cffunction name="init" hint="Constructor" access="public" returntype="Transfer" output="false">
	...
	<cfscript>
		var facadeFactory = arguments.factory.getFacadeFactory();
		var cacheConfigManager = arguments.factory.getCacheConfigManager();

		//need to do some post init injection
...
<cffunction name="get" hint="Retrieves a populated TransferObject of a given class and primary key. If no object exists for this key, an empty instance of the class is returned." access="public" returntype="TransferObject" output="false">
	...
	<cftry>
		...
		<cfscript>
			...
			return getCacheManager().get(arguments.class, rationalKey);
		</cfscript>
...
<cffunction name="cascadeCreate" hint="does a cascade down the object hierarchy, calling create as it goes" access="public" returntype="void" output="false">
	...
	<cfscript>
		var args = StructNew();
		args.useTransaction = arguments.useTransaction;

		visitObjectGraph(arguments.transfer,
						this,
						"create",
						args,
						arguments.depth
...
<cffunction name="cascadeSave" hint="does a cascade down the object hierarchy, calling create as it goes" access="public" returntype="void" output="false">
	<cfargument name="transfer" hint="The transferObject to create" type="TransferObject" required="Yes">
	<cfargument name="depth" hint="the number of levels in which to cascade, 0 is unlimited" type="numeric" required="No" default="0">
	<cfargument name="useTransaction" hint="deprecated: use TransferFactory.getTransaction for transaction management. Whether or not to use an internal transaction block" type="boolean" required="No" default="true">
	<cfscript>
...
<cffunction name="cascadeDelete" hint="does a cascade down the object hierarchy, calling create as it goes" access="public" returntype="void" output="false">
	<cfargument name="transfer" hint="The transferObject to create" type="TransferObject" required="Yes">
	<cfargument name="depth" hint="the number of levels in which to cascade, 0 is unlimited" type="numeric" required="No" default="0">
	<cfargument name="useTransaction" hint="deprecated: use TransferFactory.getTransaction for transaction management. Whether or not to use an internal transaction block" type="boolean" required="No" default="true">
	<cfscript>
...
<cffunction name="discardAll" hint="Discards all objects from the cache.  Generally for development purposes" access="public" returntype="void" output="false">
	<cfscript>
...
<!---
<cffunction name="_log" hint="" access="private" returntype="void" output="false">
	<cfargument name="log" hint="" type="string" required="Yes">
	<cflog application="true" file="transfer-cache" type="information" text="#arguments.log#">
</cffunction>
 --->
</cfcomponent>