		...
		*/
		if(NOT arguments.manytomany)
		{
			...
			arguments.buffer.writeLine("{");
				...
				arguments.buffer.writeLine("if(NOT item.__getIsProxy())");
				arguments.buffer.writeLine("{");
				...
				arguments.buffer.writeLine("{");
					arguments.buffer.writeLine('item.getOriginalTransferObject().setIsDirty(StructFind(composite, "transfer_isDirty"));');
					arguments.buffer.writeLine('item.getOriginalTransferObject().setIsPersisted(StructFind(composite, "transfer_isPersisted"));');
				arguments.buffer.writeLine("}");
