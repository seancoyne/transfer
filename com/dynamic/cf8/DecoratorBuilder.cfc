...
<cffunction name="createDecorator" hint="creates an empty Transfer Object" access="public" returntype="transfer.com.TransferDecorator" output="false">
	...
	<cfif NOT StructKeyExists(getObjectTemplates(), arguments.object.getClassName())>
		<cflock name="transfer.DecoratorBuilder.createDecorator.#arguments.object.getClassName()#" throwontimeout="true" timeout="60">
		<cfscript>
			if(NOT StructKeyExists(getObjectTemplates(), arguments.object.getClassName()))
			{
				StructInsert(getObjectTemplates(), arguments.object.getClassName(), super.createDecorator(arguments.object, arguments.transfer));
			}
		</cfscript>
		</cflock>
	</cfif>
	<cfreturn duplicate(StructFind(getObjectTemplates(), arguments.object.getClassName())) />
</cffunction>
