...
<cffunction name="createTransferObject" hint="creates an empty Transfer Object" access="public" returntype="transfer.com.TransferObject" output="false">
	...
	<cfif NOT StructKeyExists(getObjectTemplates(), arguments.object.getClassName())>
		<cflock name="transfer.TransferBuilder.createTransferObject.#arguments.object.getClassName()#" throwontimeout="true" timeout="60">
		<cfscript>
			if(NOT StructKeyExists(getObjectTemplates(), arguments.object.getClassName()))
			{
				StructInsert(getObjectTemplates(), arguments.object.getClassName(), super.createTransferObject(arguments.object));
			}
		</cfscript>
		</cflock>
	</cfif>
