...
------------------------------------------------------------------------------->
<cfcomponent hint="Exception for when a m2o is not persisted" extends="transfer.com.exception.Exception" output="false">
...
<cffunction name="init" hint="Constructor" access="public" returntype="void" output="false">
	...
	<cfscript>
		super.init("The ManyToOne TransferObject is not persisted.",
					"In TransferObject '"& arguments.object.getClassName() &"' manytoone '"& arguments.composite.getClassName() &"' has not been persisted in the database.");
	</cfscript>
</cffunction>
